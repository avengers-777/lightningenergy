...
public class ProposalDeleteContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.ProposalDeleteContract result = Contract.ProposalDeleteContract.parseFrom(super.getRawDataValue(contract));
