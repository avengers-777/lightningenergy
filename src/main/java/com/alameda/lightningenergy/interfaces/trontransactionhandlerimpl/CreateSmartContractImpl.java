...
public class CreateSmartContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.CreateSmartContract result = Contract.CreateSmartContract.parseFrom(super.getRawDataValue(contract));
