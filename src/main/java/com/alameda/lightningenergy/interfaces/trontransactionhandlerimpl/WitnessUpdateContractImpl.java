...
public class WitnessUpdateContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.WitnessUpdateContract result = Contract.WitnessUpdateContract.parseFrom(super.getRawDataValue(contract));
