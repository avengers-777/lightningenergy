...
public class UnfreezeAssetContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.UnfreezeAssetContract result = Contract.UnfreezeAssetContract.parseFrom(super.getRawDataValue(contract));
