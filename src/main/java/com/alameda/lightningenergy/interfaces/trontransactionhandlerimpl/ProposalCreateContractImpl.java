...
public class ProposalCreateContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.ProposalCreateContract result = Contract.ProposalCreateContract.parseFrom(super.getRawDataValue(contract));
