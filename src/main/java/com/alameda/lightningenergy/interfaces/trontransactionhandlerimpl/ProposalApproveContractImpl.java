...
public class ProposalApproveContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.ProposalApproveContract result = Contract.ProposalApproveContract.parseFrom(super.getRawDataValue(contract));
