...
public class UnfreezeBalanceContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.UnfreezeBalanceContract result = Contract.UnfreezeBalanceContract.parseFrom(super.getRawDataValue(contract));
