...
public class MarketSellAssetContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.MarketSellAssetContract result = Contract.MarketSellAssetContract.parseFrom(super.getRawDataValue(contract));
