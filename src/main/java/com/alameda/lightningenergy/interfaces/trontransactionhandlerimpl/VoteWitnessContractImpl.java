...
public class VoteWitnessContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.VoteWitnessContract result = Contract.VoteWitnessContract.parseFrom(super.getRawDataValue(contract));
