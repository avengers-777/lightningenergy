...
public class ExchangeInjectContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.ExchangeInjectContract result = Contract.ExchangeInjectContract.parseFrom(super.getRawDataValue(contract));
