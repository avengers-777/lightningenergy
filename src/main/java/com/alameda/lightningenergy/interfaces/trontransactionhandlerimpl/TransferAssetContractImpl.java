...
public class TransferAssetContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.TransferAssetContract result = Contract.TransferAssetContract.parseFrom(super.getRawDataValue(contract));
