...
public class MarketCancelOrderContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.MarketCancelOrderContract result = Contract.MarketCancelOrderContract.parseFrom(super.getRawDataValue(contract));
