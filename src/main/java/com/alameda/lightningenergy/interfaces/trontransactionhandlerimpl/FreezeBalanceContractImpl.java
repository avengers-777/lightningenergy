...
public class FreezeBalanceContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.FreezeBalanceContract result = Contract.FreezeBalanceContract.parseFrom(super.getRawDataValue(contract));
