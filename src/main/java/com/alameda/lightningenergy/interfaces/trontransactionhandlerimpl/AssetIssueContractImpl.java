...
public class AssetIssueContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.AssetIssueContract result = Contract.AssetIssueContract.parseFrom(super.getRawDataValue(contract));
