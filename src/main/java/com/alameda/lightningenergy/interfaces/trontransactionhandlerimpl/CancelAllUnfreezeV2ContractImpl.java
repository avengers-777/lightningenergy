...
public class CancelAllUnfreezeV2ContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.CancelAllUnfreezeV2Contract result = Contract.CancelAllUnfreezeV2Contract.parseFrom(super.getRawDataValue(contract));
        ...
        tronTransactionRecord.getTransactionData().setCancelAllUnfreezeV2Contract(result);
    ...
    public Mono<TronTransactionRecord> eventHandler(
        ...
        Contract.CancelAllUnfreezeV2Contract cancelAllUnfreezeV2Contract = record.getTransactionData().getCancelAllUnfreezeV2Contract();
        return Mono.justOrEmpty(cancelAllUnfreezeV2Contract)
                ...
                .flatMap(data -> {
                    ...
                    Flux<UpdateResult> unstakingResourcesFlux = Flux.fromIterable(tronAccount.getBalance().getUnstakingResources())
                    ...
                    Flux<UpdateResult> cancelAllUnfreeceFlux = Flux.fromIterable(tronAccount.getBalance().getUnstakingResources())
                            .filter(unstakingResource -> !unstakingResource.isUnlocked(record.getBlockHeight()))
                            .flatMap(unstakingResource -> tronAccountService.cancelUnFreeze(tronAccount.getId(),unstakingResource));
                    return Flux.merge(unstakingResourcesFlux,cancelAllUnfreeceFlux)
                            .collectList()
                            .thenReturn(record)
