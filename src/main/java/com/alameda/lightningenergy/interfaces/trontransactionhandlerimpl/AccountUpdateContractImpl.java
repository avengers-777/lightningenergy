...
public class AccountUpdateContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.AccountUpdateContract result = Contract.AccountUpdateContract.parseFrom(super.getRawDataValue(contract));
