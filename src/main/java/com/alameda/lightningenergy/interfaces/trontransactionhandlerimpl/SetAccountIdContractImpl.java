...
public class SetAccountIdContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.SetAccountIdContract result = Contract.SetAccountIdContract.parseFrom(super.getRawDataValue(contract));
