...
public class ExchangeCreateContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.ExchangeCreateContract result = Contract.ExchangeCreateContract.parseFrom(super.getRawDataValue(contract));
