...
public class UpdateEnergyLimitContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.UpdateEnergyLimitContract result = Contract.UpdateEnergyLimitContract.parseFrom(super.getRawDataValue(contract));
