...
public class UpdateBrokerageContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.UpdateBrokerageContract result = Contract.UpdateBrokerageContract.parseFrom(super.getRawDataValue(contract));
