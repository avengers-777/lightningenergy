...
public class ExchangeWithdrawContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.ExchangeWithdrawContract result = Contract.ExchangeWithdrawContract.parseFrom(super.getRawDataValue(contract));
