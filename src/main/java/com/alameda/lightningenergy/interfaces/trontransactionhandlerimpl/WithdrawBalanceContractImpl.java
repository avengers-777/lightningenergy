...
public class WithdrawBalanceContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.WithdrawBalanceContract result = Contract.WithdrawBalanceContract.parseFrom(super.getRawDataValue(contract));
