...
public class TriggerSmartContractImpl extends TronTransactionHandler {
    ...
    public TronTransactionRecord handler(Response.TransactionExtention transactionExtention, Response.TransactionInfo transactionInfo) throws InvalidProtocolBufferException {
        ...
        Contract.TriggerSmartContract result = Contract.TriggerSmartContract.parseFrom(super.getRawDataValue(contract));
